 ...
 */
public class I18nLijst
    extends Formulier implements Cloneable, Comparable<I18nLijst> {
  ...
  public I18nLijst clone() throws CloneNotSupportedException {
    I18nLijst  clone = (I18nLijst) super.clone();
