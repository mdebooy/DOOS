...
ALTER TABLE DOOS.I18N_CODES ALTER COLUMN CODE_ID DROP DEFAULT;
ALTER TABLE DOOS.I18N_CODES ALTER COLUMN CODE_ID ADD GENERATED ALWAYS AS IDENTITY;
SELECT SETVAL(PG_GET_SERIAL_SEQUENCE('doos.i18n_codes', 'code_id'), COALESCE(MAX(CODE_ID), 1))
FROM DOOS.I18N_CODES;
DROP SEQUENCE DOOS.SEQ_I18N_CODES;

ALTER TABLE DOOS.I18N_LIJSTEN ALTER COLUMN LIJST_ID DROP DEFAULT;
ALTER TABLE DOOS.I18N_LIJSTEN ALTER COLUMN LIJST_ID ADD GENERATED ALWAYS AS IDENTITY;
SELECT SETVAL(PG_GET_SERIAL_SEQUENCE('doos.i18n_lijsten', 'lijst_id'), COALESCE(MAX(LIJST_ID), 1))
FROM DOOS.I18N_LIJSTEN;
DROP SEQUENCE DOOS.SEQ_I18N_LIJSTEN;

ALTER TABLE DOOS.LOGGING ALTER COLUMN LOG_ID DROP DEFAULT;
ALTER TABLE DOOS.LOGGING ALTER COLUMN LOG_ID ADD GENERATED ALWAYS AS IDENTITY;
SELECT SETVAL(PG_GET_SERIAL_SEQUENCE('doos.logging', 'log_id'), COALESCE(MAX(LOG_ID), 1))
FROM DOOS.LOGGING;
DROP SEQUENCE DOOS.SEQ_LOGGING;

ALTER TABLE DOOS.PARAMETERS RENAME TO PARAMS;
...
ALTER TABLE DOOS.TALEN ADD  COLUMN TAAL_ID                         INTEGER         NOT NULL  GENERATED ALWAYS AS IDENTITY;
ALTER TABLE DOOS.TALEN DROP CONSTRAINT PK_TALEN;
ALTER TABLE DOOS.TALEN ADD  CONSTRAINT PK_TALEN PRIMARY KEY (TAAL_ID);
...
SELECT ISO_639_2T, EIGENNAAM, TAAL_ID
FROM   DOOS.TALEN
